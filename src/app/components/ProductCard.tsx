...
import { MessageCircle, Tag, Package, X, ChevronRight, ChevronLeft } from "lucide-react";
...
function ImageCarousel({ images, alt, compact = false }: { images: string[]; alt: string; compact?: boolean }) {
